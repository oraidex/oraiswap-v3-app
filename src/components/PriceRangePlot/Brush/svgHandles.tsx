...
export const LeftHandle: React.FC<Pick<ISVGHandle, 'height' | 'fill'>> = ({ height = 0, fill }) => (
  <>
    ...
    <path d='M5 5V15' stroke={colors.oraidex.dark} strokeOpacity='0.5' />
    <path d='M8 5V15' stroke={colors.oraidex.dark} strokeOpacity='0.5' />
  </>
)
...
export const RightHandle: React.FC<Pick<ISVGHandle, 'height' | 'fill'>> = ({
  ...
  <>
    ...
    <path d='M29 5V15' stroke={colors.oraidex.dark} strokeOpacity='0.5' />
    <path d='M32 5V15' stroke={colors.oraidex.dark} strokeOpacity='0.5' />
  </>
)
